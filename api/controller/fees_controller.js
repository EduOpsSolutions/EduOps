...
export const listCourseBatchPairs = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "An error occurred while fetching course-batch pairs." });
  }
};
...
export const updateFee = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: "An error occurred while updating the fee." });
    }
};
...
export const deleteFee = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: "An error occurred while deleting the fee." });
    }
};
