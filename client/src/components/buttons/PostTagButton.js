...
function PostTagButton({tag, status, onClick}) {
    ...
    switch(tag) {
        case 'global':
            buttonClass = "border-[#CCA421] bg-german-yellow";
            buttonText = "Global";
            buttonIcon = (
            ...
            break;
        case 'student':
            buttonClass = "border-[#DC2626] bg-red-200";
            buttonText = "Student";
            buttonIcon = (
            ...
            break;
        case 'teacher':
            buttonClass = "border-[#047857] bg-green-200";
            buttonText = "Teacher";
            buttonIcon = (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-[22px] me-2">
    ...
    return (
        ...
        <button 
            ...
            className={`flex flex-row items-center py-[5px] px-3 border-2 rounded-md ${buttonClass}`} 
            disabled={isLocked}
        >
            {buttonIcon}
