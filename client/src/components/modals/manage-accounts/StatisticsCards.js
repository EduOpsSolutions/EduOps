...
const StatCard = ({ icon, title, value, colorClass }) => (
  <div className="bg-white border-2 border-dark-red rounded-lg p-4 hover:shadow-md transition-shadow">
    <div className="flex items-center">
      <div className={`bg-gradient-to-br ${colorClass} rounded-full p-2 mr-3`}>
        {icon}
      </div>
      <div>
