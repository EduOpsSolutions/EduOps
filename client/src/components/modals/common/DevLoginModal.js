        ...
        <Modal.Body>
          ...
          <div className="flex flex-col gap-5 justify-center items-center">
            <div className="w-full flex">
              <SmallButton onClick={navigateToStudent}>Student</SmallButton>
              <SmallButton onClick={navigateToTeacher}>Teacher</SmallButton>
            </div>
            <div className="w-full flex">
              <SmallButton onClick={navigateToAdmin}>Admin</SmallButton>
            </div>
          </div>
        </Modal.Body>
      </div>
