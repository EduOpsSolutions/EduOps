...
function AdminNavbar() {
    ...
    return (
        ...
        <div className="flex w-full justify-center items-center font-bold text-lg">
            <Link to='/admin' className="me-6 hover:text-gray-500">Home</Link>
            <div className="relative me-6 hover:text-gray-500" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <NavLink to="/admin">Enrollment</NavLink>
          {isDropdownOpen && (
            <ul className="absolute bg-white shadow-md rounded-md py-1 mt-1">
              <li>
                <NavLink to="/admin/enrollment/schedule" className="block px-4 py-2 hover:bg-gray-100">
                  Schedule
                </NavLink>
              </li>
              <li>
                <NavLink to="/admin/CourseManagement" className="block px-4 py-2 hover:bg-gray-100">
                  Course Management
                </NavLink>
              </li>
            </ul>
            ...
            <Link to='/admin/grades' className="me-6 hover:text-gray-500">Grades</Link> 
            <Link to='/admin/payment' className="me-6 hover:text-gray-500">Payment</Link> 
            <Link to='/admin/documents' className="me-6 hover:text-gray-500">Documents</Link> 
            <Link to='/admin/accounts' className="hover:text-gray-500">Accounts</Link> 
        </div>
