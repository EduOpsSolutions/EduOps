  ...
  return (
    <nav className="w-full h-20 flex flex-row justify-center items-center bg-german-red text-white px-8 py-2 border-b-[5px] border-dark-red-2 z-10 select-none">
      ...
      <div className="flex w-full justify-center items-center font-bold text-lg">
        <Link to={`/${role}`} className="me-6 hover:text-dark-red-4">
          {' '}
          Home{' '}
        </Link>
        ...
        {['student', 'admin'].includes(role) && (
          <Link to={`/${role}/grades`} className="me-6 hover:text-dark-red-4">
            {' '}
            Grades{' '}
          </Link>
        )}
        ...
        {['student', 'teacher'].includes(role) && (
          <Link
            to={`/${role}/documents`}
            className="me-6 hover:text-dark-red-4"
          >
            {' '}
            Documents{' '}
          </Link>
        ...
        >
          ...
          <Dropdown.Item className="text-base text-white hover:bg-gray-700 focus:bg-gray-700">
            ...
            <div class="w-full ps-3">
              <div class="text-left text-gray-500 text-sm mb-1.5">
                New message from{' '}
                <span class="font-semibold text-white">Jese Leos</span>: "Hey,
                what's up? All set for the presentation?"
              </div>
              <div class="text-left text-xs text-german-yellow">
                a few moments ago
              </div>
            </div>
          </Dropdown.Item>
          ...
          <div class="flex justify-center items-center text-white text-sm font-semibold py-[10px] px-4">
            <svg
              class="w-4 h-4 me-2 text-gray-500 dark:text-gray-500"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 20 14"
