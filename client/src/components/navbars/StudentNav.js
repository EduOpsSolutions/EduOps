  ...
  return (
    <nav className="w-full h-20 flex flex-row justify-center items-center bg-german-red text-white px-8 py-2 border-b-[5px] border-dark-red-2 z-10">
      ...
      <div className="flex w-full justify-center items-center font-bold text-lg">
        <Link to="/student" className="me-6 hover:text-gray-500">
          Home
        </Link>
        <Link to="/student/enrollment" className="me-6 hover:text-gray-500">
          Enrollment
        </Link>
        <Link to="/student" className="me-6 hover:text-gray-500">
          Grades
        ...
        <Link to="/student/documents" className="hover:text-gray-500">
          Documents
        </Link>
      </div>
