    ...
    return (
        <div className="relative z-0 w-full mb-5 group">
            <input
                ...
                id={id}
                required={required}
                className="block py-2.5 px-0 w-full text-sm bg-white pl-2 text-gray-900 bg-transparent border-2 border-b-2 border-gray-300 rounded-md appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-dark-red peer"
                placeholder=""
            />
