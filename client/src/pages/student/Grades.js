...
function Grades() {
  ...
  return (
    <section
      className="flex flex-col items-start justify-start bg-white-yellow-tone bg-center bg-cover bg-repeat bg-blend-multiply h-full"
          ...
          <table class="text-sm text-left text-black w-full mt-4 table-fixed bg-transparent">
            ...
            <tbody>
              ...
              <tr class=" dark:bg-gray-500 dark:border-gray-700 border-b border-b-gray-500">
                ...
                <td class="px-6 py-2 text-center">NO GRADE</td>
                ...
                <td class="px-6 py-2 flex justify-center items-center">
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="text-gray-300 size-6 cursor-pointer"
                    onClick={() => setGradeNotReadyModal(true)}
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <tr class=" dark:bg-gray-800 border-b border-b-gray-500">
                ...
                <td class="px-6 py-2 text-center">PASS</td>
                <td class="px-6 py-2 flex justify-center items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <tr class=" dark:bg-gray-800 border-b border-b-gray-500">
                ...
                <td class="px-6 py-2 text-center">FAIL</td>
                <td class="px-6 py-2 flex justify-center items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
