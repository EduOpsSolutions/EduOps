    ...
    <div className="flex-1 flex flex-col items-center relative z-10 mt-24">
      ...
      <form className="flex flex-col items-center w-2/3 mt-2">
        ...
        <div className="relative mb-3 mt-3 w-full">
          ...
          <input type="text" id="email" name="email" className="border border-black pl-10 pr-4 py-1 h-10 focus:outline-none bg-white-yellow-tone w-full" placeholder="User ID or Email" onChange={handleEmailChange} />
        </div>
        ...
        <div className="self-end">
          <p className="mt-2 text-sm text-german-yellow hover:text-bright-red cursor-pointer underline" onClick={navigateToForgotPassword}>
            Forgot password?
          </p>
        </div>
