    ...
    >
      <div className="relative max-w-full mx-auto bg-transparent w-full px-8 py-4 mt-4 mb-12 flex flex-col">
        ...
        <div className="relative max-w-full mx-auto bg-white w-11/12 px-8 py-4 flex flex-col text-justify shadow-gray-300 shadow-lg drop-shadow-lg rounded-lg">
          ...
          <p className="mb-4">
            EduOps is committed to providing quality services to you and this
            policy outlines our ongoing obligations to you in respect of how we
            manage your Personal Information.
          </p>
          <p className="mb-4">
            We have adopted the National Privacy Commission (NPCs) contained in
            the Republic Act No. 10173.The NPCs govern the way in which we
            collect, use, disclose, store, secure and dispose of your Personal
            Information.
          </p>
          <p className="mb-4">
            A copy of the National Privacy Commission may be obtained from the
            website of National Privacy Commission at
          ...
          <p className="mb-4">
            ...
            via our website, from your website, from media and publications,
            from other publicly available sources, from cookies- delete all that
            aren’t applicable] and from third parties. We don’t guarantee
          ...
          <p className="mb-4">
            <span className="font-bold">EduOps</span> will not charge any fee
