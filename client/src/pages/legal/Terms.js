...
function Terms() {
  ...
  return (
    <section
      className="flex items-start justify-start flex-row bg-white-yellow-tone bg-center bg-cover bg-repeat bg-blend-multiply"
      style={{ backgroundImage: `url(${Bg_image})`, minHeight: "100vh" }}
    >
      <div className="relative max-w-full mx-auto bg-transparent w-full px-8 py-4 mt-4 mb-12 flex flex-col">
        {role === "legal" && (
          <BackButton onClick={navigateToLogin} className="mr-4 z-50" />
        )}
        ...
        <div className="relative max-w-full mx-auto bg-white w-11/12 px-8 py-4 flex flex-col text-justify shadow-gray-300 shadow-lg drop-shadow-lg rounded-lg">
          ...
          <p className="mb-4">
            ...
            EduOps, Inc. ("Company," "we," "our," or "us"). The following terms
            and conditions, together with any documents they expressly
            incorporate by reference (collectively "Terms of Service"), govern
            your access to and use of www.EduOps.com, including any content,
            functionality, and services offered on or through www.EduOps.com
            (the "Website").
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            reference. If you do not want to agree to these Terms of Service,
            you must not access or use the Website.
          </p>
          <p className="mb-4">
            You must be at least 13 years old to use this Website. However,
            children of all ages may use the Website if enabled by a parent or
            legal guardian. If you are under 18, you represent that you have
            your parent or guardian's permission to use the Website. Please have
            them read these Terms of Service with you.
          </p>
          <p className="mb-4">
            If you are a parent or legal guardian of a user under the age of 18,
            by allowing your child to use the Website, you are subject to the
            terms of these Terms of Service and responsible for your child's
          ...
          <p className="mb-4">
            ...
            UNDER APPLICABLE LAW TO FORM A BINDING CONTRACT WITH US; AND, YOU
            AGREE IF YOU ACCESS THE WEBSITE FROM A JURISDICTION WHERE IT IS NOT
          ...
          <p className="mb-4">
            Continuing to use the Website following the posting of revised Terms
          ...
          <p className="mb-4">
            YOU ARE SOLELY AND ENTIRELY RESPONSIBLE FOR YOUR USE OF THE WEBSITE
