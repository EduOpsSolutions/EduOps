...
import {
  useDocumentSignatureSearchStore,
  useDocumentSignatureStore,
} from "../../stores/documentSignatureStore";
        ...
        {error && (
          <div className="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded">
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={() =>
                  useDocumentSignatureStore.setState({ error: "" })
                }
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 lg:gap-16 lg:items-start">
          ...
          <div className="w-full lg:flex-1 bg-white border-dark-red-2 border-2 rounded-lg p-4 sm:p-6 lg:p-10">
                          ...
                          <td className="py-3">
                            <div className="flex justify-center items-center gap-4 flex-wrap">
                              ...
                              <button
                                onClick={() =>
                                  navigate(
                                    `/admin/document-validation?signature=${document.fileSignature}`
                                  )
                                }
            ...
            {!loading && searchStore.totalItems === 0 && (
              <div className="text-center py-10">
                <p className="text-gray-500 text-sm sm:text-base">
                  No document signatures found. Upload a document to get
                  started.
                </p>
              </div>
            )}
