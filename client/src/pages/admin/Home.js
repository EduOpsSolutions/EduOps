...
function Home() {
  ...
  const profilePic = localStorage.getItem("profilePicLink");
              ...
              >
                {profilePic && (
                  <img
                    src={profilePic}
                    alt=""
                    className="size-14 sm:size-16 md:size-20 border-[3px] border-german-yellow rounded-full me-3 sm:me-4 md:me-5 object-cover"
                  />
                )}
                {!profilePic && (
                  <span className="size-14 sm:size-16 md:size-20 border-[3px] border-german-yellow rounded-full me-3 sm:me-4 md:me-5 text-center items-center justify-center flex text-white font-bold bg-german-red">
                    {userInitials}
                  </span>
                )}
