                        ...
                        >
                          ...
                          <td className="py-2 md:py-3 px-2 sm:px-3 md:px-4 border-t border-b border-red-900 text-xs sm:text-sm md:text-base">
                            <div 
                              ...
                              title={transaction.feeType?.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
                            >
                              {transaction.feeType?.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
                            </div>
                          </td>
                          <td className="py-2 md:py-3 px-2 sm:px-3 md:px-4 border-t border-b border-red-900 text-xs sm:text-sm md:text-base">
                            <div 
                          ...
                          <td className="py-2 md:py-3 px-2 sm:px-3 md:px-4 border-t border-b border-red-900 text-xs sm:text-sm md:text-base">
                            <div 
                              className="truncate max-w-28 sm:max-w-32 md:max-w-36 lg:max-w-none" 
                          ...
                          <td className="py-2 md:py-3 px-2 sm:px-3 md:px-4 border-t border-b border-red-900 text-xs sm:text-sm md:text-base">
                            <div 
                              ...
                              title={new Date(transaction.createdAt).toLocaleDateString()}
                            >
