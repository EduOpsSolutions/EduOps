...
function Transaction() {
    ...
    const sampleStudents = [
        ...
        ...Array.from({ length: 25 }, (_, i) => ({
            ...
            course: `${['A1', 'A2', 'B1', 'B2', 'C1'][i % 5]} German ${['Basic', 'Intermediate', 'Advanced'][i % 3]}`,
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-300">
                                                <th className="text-left py-3 px-4 font-semibold border-t-2 border-b-2 border-red-900">Student ID</th>
                                                <th className="text-left py-3 px-4 font-semibold border-t-2 border-b-2 border-red-900">Name</th>
                                                <th className="text-left py-3 px-4 font-semibold border-t-2 border-b-2 border-red-900">Course</th>
                                                <th className="text-left py-3 px-4 font-semibold border-t-2 border-b-2 border-red-900">Email</th>
                                                <th className="text-left py-3 px-4 font-semibold border-t-2 border-b-2 border-red-900">Phone Number</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {currentStudents.map((student, index) => (
                                                ...
                                                >
                                                    <td className="py-3 px-4 border-t border-b border-red-900">{student.studentId}</td>
                                                    <td className="py-3 px-4 border-t border-b border-red-900">{student.studentName}</td>
                                                    <td className="py-3 px-4 border-t border-b border-red-900">{student.course}</td>
                                                    <td className="py-3 px-4 border-t border-b border-red-900">{student.email}</td>
                                                    <td className="py-3 px-4 border-t border-b border-red-900">{student.phoneNumber}</td>
                                                </tr>
                                            ))}
                                            {currentStudents.length === 0 && (
                                                <tr>
                                                    <td colSpan="5" className="text-center py-8 text-gray-500 border-t border-b border-red-900">
                                                        No students found
                                                    </td>
                                                </tr>
                                            )}
