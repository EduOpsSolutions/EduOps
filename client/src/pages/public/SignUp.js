    ...
    >
      ...
      <div className="relative max-w-full mx-auto bg-white-yellow-tone w-11/12 px-8 py-4 mt-32 mb-12 flex flex-col">
        ...
        <form className="px-8 py-4 flex flex-col">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  id="mother_deceased"
                  className="peer mt-3 text-dark-red focus:border-dark-red focus:ring-dark-red-2"
                />
              </div>
              <LabelledInputField
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
              <div className="flex justify-center items-center">
                <input
                  ...
                  id="father_deceased"
                  className="peer text-dark-red focus:border-dark-red focus:ring-dark-red-2"
                />
              </div>
              <LabelledInputField
          ...
          <div class="grid md:grid-cols-3 md:gap-6">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
              <div className="flex justify-center items-center">
                <input
                  type="checkbox"
                  name="guardian_deceased"
                  id="guardian_deceased"
                  className="peer text-dark-red focus:border-dark-red focus:ring-dark-red-2"
                />
              </div>
              <LabelledInputField
          ...
          <SmallButton onClick={""}>Proceed</SmallButton>
        </form>
      </div>
    </section>
  );
