...
function resetPassword() {
  return (
    <div
      className="flex flex-col items-center justify-center bg-white-yellow md:h-auto md:min-h-[50vh] min-w-[30%] bg-dark-red-5"
      style={{
    ...
    >
      ...
      <form className="flex flex-col items-center w-5/6 my-2">
        ...
        <a href="index.html">
          <button
            type="button"
            className="mt-5 w-32 h-10 self-center font-bold bg-dark-red-2 text-white-yellow hover:bg-german-red ease-in duration-150"
          >
            Confirm
          </button>
        </a>
