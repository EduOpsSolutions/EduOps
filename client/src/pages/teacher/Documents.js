            ...
            <div className="w-full bg-white border-dark-red-2 border-2 rounded-lg p-4 sm:p-6 lg:p-10">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                    ...
                    <button
                        ...
                        type="button"
                        className="text-white bg-dark-red-2 hover:bg-dark-red-5 focus:outline-none font-semibold rounded-md text-sm sm:text-md px-6 sm:px-8 py-2 shadow-sm shadow-black ease-in duration-150"
                    >
                        See Requests
                    </button>
                </div>
