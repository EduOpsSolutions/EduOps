...
-   <span class="package-name">[`@stdlib/assert-is-leap-year-cli`][@stdlib/assert-is-leap-year-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-is-leap-year-cli]: https://www.npmjs.com/package/@stdlib/assert-is-leap-year-cli
